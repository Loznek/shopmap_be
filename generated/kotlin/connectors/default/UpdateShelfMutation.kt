...
public interface UpdateShelfMutation :
    GeneratedMutation<
      DefaultConnector,
      UpdateShelfMutation.Data,
      UpdateShelfMutation.Variables
    >
{
  ...
  public data class Variables(
    ...
    OptionalVariable<Int?>
      ...
      public interface Builder {
        ...
        public var department: java.util.UUID?
      ...
      public companion object {
        ...
        public fun build(
          ...
          var id= id
            var department: OptionalVariable<java.util.UUID?> = OptionalVariable.Undefined
          ...
          return object : Builder {
            ...
            override var department: java.util.UUID?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { department = OptionalVariable.Value(value_) }
          ...
          .let {
            Variables(
              id=id,department=department,width=width,height=height,startX=startX,startY=startY,
            )
          }
        }
      }
  ...
  public companion object {
    public val operationName: String = "UpdateShelf"
    public val dataDeserializer: DeserializationStrategy<Data> = serializer()
    public val variablesSerializer: SerializationStrategy<Variables> = serializer()
  }
}

public fun UpdateShelfMutation.ref(
  
    id: java.util.UUID,
  
    block_: UpdateShelfMutation.Variables.Builder.() -> Unit
  ...
  ref(
      ...
      UpdateShelfMutation.Variables.build(
        id=id,
...
public suspend fun UpdateShelfMutation.execute(
