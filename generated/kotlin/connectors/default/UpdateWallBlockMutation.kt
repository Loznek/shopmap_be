...
public interface UpdateWallBlockMutation :
    GeneratedMutation<
      DefaultConnector,
      UpdateWallBlockMutation.Data,
      UpdateWallBlockMutation.Variables
    >
{
  ...
  public companion object {
    public val operationName: String = "UpdateWallBlock"
    public val dataDeserializer: DeserializationStrategy<Data> = serializer()
    public val variablesSerializer: SerializationStrategy<Variables> = serializer()
  }
}

public fun UpdateWallBlockMutation.ref(
  
    id: java.util.UUID,
  
    block_: UpdateWallBlockMutation.Variables.Builder.() -> Unit
  ...
  ref(
      ...
      UpdateWallBlockMutation.Variables.build(
        id=id,
...
public suspend fun UpdateWallBlockMutation.execute(
